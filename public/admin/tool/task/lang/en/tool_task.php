...
$string['criticallyoverduetaskscount'] = '{$a} critically overdue task(s).';
...
$string['duetaskscount'] = '{$a} due task(s).';
...
$string['futuretaskscount'] = '{$a} future task(s).';
...
$string['overduetaskscount'] = '{$a} overdue task(s).';
...
$string['taskssummary'] = '{$a->criticallyoverdue} {$a->overdue} {$a->due} {$a->future}';
