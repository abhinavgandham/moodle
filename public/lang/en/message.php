...
$string['ago'] = '{$a} ago';
$string['alreadyunsubscribed'] = 'The email \'{$a->email}\' is already unsubscribed from \'{$a->component}\'.';
...
$string['confirmunsubscribe'] = 'Are you sure you want to stop receiving email notifications for "{$a->component}" for {$a->email}?';
...
$string['unsubscribed'] = 'The email \'{$a->email}\' was unsubscribed from \'{$a->component}\'.';
